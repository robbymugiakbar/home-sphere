...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-6xl mx-auto mb-20'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-10'>
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        <div className='flex flex-col items-center'>
                            <p>Regular Price</p>
                            {formData.type === 'rent' && (<span className='text-xs'>(IDR / Month)</span>)}
                        </div>
                    </div>
                    {formData.offer &&(
                        <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg hover:bg-slate-800 disabled:opacity-80'>{loading ? 'Creating...' : 'Create Listing'}</button>
